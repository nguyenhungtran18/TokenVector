...
## 4. Hướng dẫn Tối ưu hóa & Động cơ MoE Streaming

Xem tài liệu chuyên sâu tại [OPTIMIZATION_GUIDE.md](OPTIMIZATION_GUIDE.md) về:
- **5 Kỹ thuật viết mã TokenVector ngắn hơn cả Python** (Type Inference, Loop Merging, Direct Expression Return).
- **Kiến trúc MoE Disk Streaming Engine** nạp động mô hình GGUF/MoE từ ổ cứng với mức RAM <450MB.
- **Bảng Benchmark Thực tế** giữa Python và TokenVector.

## 5. Giới hạn thật (không giấu)
